...
### Языковая граница операций в готовящемся checkpoint
...
| Текущий production `156e2f7` | Ready; два локальных build/TS, Vercel build 9 с; health 200 ok в 16:47 | Локально фон покрывает 390×844, графитовая форма видима в светлой теме; слышимость после reload и клавиатура ОС не приняты |
...
Приоритет следующей работы — проверить заявленную тишину автоматического и ручного TTS в desktop Codex IAB после нового пакета, затем выполнить приёмку на живом микрофоне и проверить реальную мобильную клавиатуру/Safari. Текущие изменения уже входят в опубликованный `156e2f7`; следующая правка требует собственного deployment и SHA. Публикация `156e2f7`, настройка VAD и реакция частиц не подтверждают устранение тишины или достижение 1,5 секунды.
