...
type Supervision = {
  ...
  latencyBySource: { source: "llm" | "slot" | "confirmation" | "catalog_example" | "social"; count: number; p50ServerMs: number | null; p95ServerMs: number | null; p50RoutingMs: number | null; p95RoutingMs: number | null }[];
};
